...
cd..
del /Q IBLayer3.exe
"./ext/tcc/tcc.exe" src/imbored.c src/ib_ide.c -Isrc -Iext/tcc/libtcc/ -L./ -Lext/raylib -Iext/raylib -lmsvcrt -lraylib -lopengl32 -lgdi32 -lwinmm -lkernel32 -lshell32 -luser32 -llibtcc -w -o IBLayer3.exe
